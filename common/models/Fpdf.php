...
// print_r(is_file(dirname(__FILE__).'/font/helveticab.php'));\

// die;

define('FPDF_VERSION','1.6');
// define('FPDF_FONTPATH',Yii::$app->basePath.'/../common/models/'); 
...
{
// echo 	'C:\xampp\htdocs\macroims\common\models/font/';
// 	die('aaa');
	//Start a new page
	if($this->state==0)
		$this->Open();
...
// 
	if(!defined('FPDF_FONTPATH') && is_dir(dirname(__FILE__).'/font'))
		// define('FPDF_FONTPATH',dirname(__FILE__).'/font/');
		define('FPDF_FONTPATH','C:\xampp\htdocs\macroims\common\models/font/');
